...
<main>
    ...
    <section>
        ...
        <div>
            <img src="<?php print BASE_URL . 'assets/images/alakformalo-cellulit-kezeles.webp'; ?>" alt="Alakformáló-cellulit kezelés 70 perc">
        </div>
    </section>
    <section>
        ...
        <div>
            <img src="<?php print BASE_URL . 'assets/images/feszesito-kezeles.webp'; ?>" alt="Feszesítő kezelés 70 perc">
        </div>
    </section>
</main>