...
<nav aria-label="Admin navigáció" class="admin-sidebar">
    <ul class="admin-nav">
        ...
        <li><a href="<?php print BASE_URL . 'logout'; ?>">Kijelentkezés</a></li>
    </ul>
</nav>
<!-- üdvözlő üzenet -->
            ...
            <?php foreach ($arguments as $argument): ?>
                <li>
                    <form action="" method="post" class="edit-form">
                        ...
                        <button type="submit" name="action" value="update_argument" class="btn click hover-effect">Mentés</button>
